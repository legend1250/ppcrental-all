...
namespace PPCRental.AcceptanceTests.StepDefinitions
{
    ...
    public class UC001_SearchSteps
    {
        ...
        [Then(@"the list of found project should be:")]
        public void ThenTheListOfFoundProjectShouldBe(Table expectedProjects)
        {
            _searchDriver.ShowListProject(expectedProjects);
        }
    }
}
